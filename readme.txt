...
- Changed `giggsey/locale_list` from `9.0.22` to `9.0.27`.
- Changed `justinrainbow/json-schema` from `5.3.1` to `5.3.3`.
- Changed `mck89/peast` from `v2.1.8` to `v2.2.0`.
- Changed `nb/oxymel` from `v1.4.0` to `v1.4.1`.
...
[1.10.0]: https://github.com/pronamic/wp-pronamic-pay-with-mollie-for-woocommerce/compare/v1.9.0...v1.10.0
...
[1.9.0]: https://github.com/pronamic/wp-pronamic-pay-with-mollie-for-woocommerce/compare/v1.8.0...v1.9.0
...
Full set of changes: [`1.7.4...1.8.0`][1.8.0]

[1.8.0]: https://github.com/pronamic/wp-pronamic-pay-with-mollie-for-woocommerce/compare/v1.7.4...v1.8.0
...
Full set of changes: [`1.7.3...1.7.4`][1.7.4]

[1.7.4]: https://github.com/pronamic/wp-pronamic-pay-with-mollie-for-woocommerce/compare/v1.7.3...v1.7.4
